...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " truecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  truecoin-tx [options] <hex-tx> [commands]  Update hex-encoded truecoin transaction\n" +
            "or:     truecoin-tx [options] -create [commands]   Create hex-encoded truecoin transaction\n" +
            "\n";
