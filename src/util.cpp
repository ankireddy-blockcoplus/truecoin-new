...
const char * const BITCOIN_CONF_FILENAME = "truecoin.conf";
const char * const BITCOIN_PID_FILENAME = "truecoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Truecoin";
#else
    // Unix
