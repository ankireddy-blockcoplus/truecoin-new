...
"""Verify that starting truecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start truecoin with -h for help text")
        ...
        self.log.info("Start truecoin with -version for version information")
        ...
        self.log.info("Start truecoind with -fakearg to make sure it does not start")
