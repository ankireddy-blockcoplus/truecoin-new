# Support for Output Descriptors in Truecoin Core

Since Truecoin Core v0.17, there is support for Output Descriptors in the
...
on Truecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Truecoin Core wallets, a convenience function `combo` is
