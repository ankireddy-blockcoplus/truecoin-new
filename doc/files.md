...
* truecoin.conf: contains configuration settings for truecoind or truecoin-qt
* truecoind.pid: stores the process id of truecoind while running
...
* debug.log: contains debug information and general logging generated by truecoind or truecoin-qt
